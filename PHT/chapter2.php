...
// - Ngược lại, nếu $diem_tb >= 6.5 VÀ $co_di_hoc_chuyen_can == true =>
//"Xếp loại: Khá"
// - Ngược lại, nếu $diem_tb >= 5.0 VÀ $co_di_hoc_chuyen_can == true =>
//"Xếp loại: Trung bình"
// - Các trường hợp còn lại (bao gồm cả $co_di_hoc_chuyen_can == false) =>
//"Xếp loại: Yếu (Cần cố gắng thêm!)"
// Gợi ý: Dùng toán tử && (AND)

if ($co_di_hoc_chuyen_can == true && $diem_tb >= 8.5) {
    echo "Xếp loại:Giỏi";
}elseif ($co_di_hoc_chuyen_can == true && $diem_tb >= 6.5) {
    echo "Xếp loại:Khá";
}elseif ($co_di_hoc_chuyen_can == true && $diem_tb >= 5.0) {
